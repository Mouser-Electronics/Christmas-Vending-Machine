/*
  ...
  Christmas vending maching project
  Modified by Rafik, Dec 9th, 2019
*/
...
void loop() {
  ...
  if (digitalRead(2) == HIGH){
    ...
    stepper.setSpeed(5); 
    stepper.step(-600); //angle need to be adjusted depending how you positioned them 
    delay(1000);
    myservo.write(135); //angle need to be adjusted depending how you positioned them 
    delay(500);
    myservo.write(80); //angle need to be adjusted depending how you positioned them 
    
    Serial.println(randNumb);
    //will play a song from
    sing(randNumb); // as delay then door will close
